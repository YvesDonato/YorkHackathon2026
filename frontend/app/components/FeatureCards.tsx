    ...
    <section className="mt-16 grid gap-4 md:mt-20 md:grid-cols-3">
      {features.map((feature) => (
        <motion.article
          ...
          className="relative border border-white/10 bg-white/[0.03] p-6 backdrop-blur-sm transition-colors duration-200 hover:z-10 hover:border-[var(--accent-primary)]/40 hover:bg-white/[0.05] hover:shadow-[0_18px_40px_rgba(0,0,0,0.35)]"
